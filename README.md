...
- Core Contributions:
  ...
  2. Aims to address the challenge of limited cross‑subject generalization in EEG‑based DD detection, thereby helping to mitigate the adverse effects of inherent inter‑subject variability in EEG signals.
